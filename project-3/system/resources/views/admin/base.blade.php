...
<img class="img-circle elevation-2" src="{{ url('public')}}/assets-admin/dist/img/akun.jpeg" alt="User Image" style="width: 30px; height: 30px;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ url('public') }}/assets-admin/dist/img/mlogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Pillow-Mart</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">VINI DAWVI</a>
        </div>
      </div>
